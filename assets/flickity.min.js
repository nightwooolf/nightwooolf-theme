 ...
 */ ((function (e, i) {
  typeof define == "function" && define.amd
    ? define("jquery-bridget/jquery-bridget", ["jquery"], function (t22) {
        return i(e, t22);
      })
  ...
  function n(h, s, c) {
    ...
    (s.prototype.option ||
      (s.prototype.option = function (t22) {
        c.isPlainObject(t22) &&
          (this.options = c.extend(!0, this.options, t22));
      }),
      (c.fn[h] = function (t22) {
        if (typeof t22 == "string") {
          var e2 = o.call(arguments, 1);
          return i2(this, t22, e2);
        }
        return (n2(this, t22), this);
      }));
    ...
    function n2(t22, n3) {
      t22.each(function (t23, e2) {
        var i3 = c.data(e2, h);
        i3
          ? (i3.option(n3), i3._init())
          : ((i3 = new s(e2, n3)), c.data(e2, h, i3));
      });
    }
    a(c);
  }
  function a(t22) {
    !t22 || (t22 && t22.bridget) || (t22.bridget = n);
  }
  ...
  (function (t22, e) {
    ...
    return (
      ...
      (e.emitEvent = function (t23, e2) {
        var i = this._events && this._events[t23];
        if (!(!i || !i.length)) {
          ((i = i.slice(0)), (e2 = e2 || []));
          for (
            var n = this._onceEvents && this._onceEvents[t23], s = 0;
            s < i.length;
            s++
          ) {
            var r = i[s],
 ...
 */ ((function (t22, e) {
  ...
  function x() {
    if (!n) {
      ...
      ((t22.style.width = "200px"),
        (t22.style.padding = "1px 2px 3px 4px"),
        (t22.style.borderStyle = "solid"),
        (t22.style.borderWidth = "1px 2px 3px 4px"),
        (t22.style.boxSizing = "border-box"));
      var e2 = document.body || document.documentElement;
      e2.appendChild(t22);
      var i2 = S(t22);
      ((C = Math.round(m(i2.width)) == 200),
        (s.isBoxSizeOuter = C),
        e2.removeChild(t22));
    }
  }
  function s(t22) {
    if (
      (x(),
      typeof t22 == "string" && (t22 = document.querySelector(t22)),
      !(!t22 || typeof t22 != "object" || !t22.nodeType))
    ) {
      var e2 = S(t22);
      ...
      for (
        var n2 = (i2.isBorderBox = e2.boxSizing == "border-box"), s2 = 0;
        s2 < b;
        s2++
      ) {
        var r = y[s2],
      ...
      var g = m(e2.height);
      return (
        g !== !1 && (i2.height = g + (p ? 0 : h + f)),
        (i2.innerWidth = i2.width - (l + d)),
        (i2.innerHeight = i2.height - (h + f)),
        (i2.outerWidth = i2.width + c),
        (i2.outerHeight = i2.height + u),
        i2
      );
    }
  }
  ...
  (function (e, i) {
    ...
    var c = {};
    ((c.extend = function (t22, e) {
      for (var i2 in e) t22[i2] = e[i2];
      return t22;
    }),
      (c.modulo = function (t22, e) {
        return ((t22 % e) + e) % e;
      }));
    var i = Array.prototype.slice;
    ((c.makeArray = function (t22) {
      if (Array.isArray(t22)) return t22;
      if (t22 == null) return [];
      var e = typeof t22 == "object" && typeof t22.length == "number";
      return e ? i.call(t22) : [t22];
    }),
      (c.removeFrom = function (t22, e) {
      ...
      (c.getQueryElement = function (t22) {
        return typeof t22 == "string" ? document.querySelector(t22) : t22;
      }),
      (c.handleEvent = function (t22) {
        var e = "on" + t22.type;
        this[e] && this[e](t22);
      }),
        ...
        return (
          t22.forEach(function (t23) {
            if (t23 instanceof HTMLElement) {
              ...
              r(t23, n) && s.push(t23);
              for (var e = t23.querySelectorAll(n), i2 = 0; i2 < e.length; i2++)
                s.push(e[i2]);
            }
          }),
          s
      ...
      (c.debounceMethod = function (t22, e, n) {
        ...
        t22.prototype[e] = function () {
          ...
          var e2 = arguments,
            i2 = this;
          this[r2] = setTimeout(function () {
            (s.apply(i2, e2), delete i2[r2]);
          }, n);
        };
      }),
      (c.docReady = function (t22) {
        ...
        e == "complete" || e == "interactive"
          ? setTimeout(t22)
          : document.addEventListener("DOMContentLoaded", t22);
      }),
      (c.toDashed = function (t22) {
        return t22
          .replace(/(.)([A-Z])/g, function (t23, e, i2) {
            return e + "-" + i2;
          })
          .toLowerCase();
      }));
        ...
        c.docReady(function () {
          ...
          n.forEach(function (e2) {
            var t23 = e2.getAttribute(s) || e2.getAttribute(r2),
              i3;
            try {
              i3 = t23 && JSON.parse(t23);
            } catch (t24) {
              u &&
                u.error(
                  "Error parsing " + s + " on " + e2.className + ": " + t24,
                );
              return;
            }
            var n2 = new a(e2, i3);
  ...
  (function (e, i) {
    typeof define == "function" && define.amd
      ? define("flickity/js/cell", ["get-size/get-size"], function (t22) {
          return i(e, t22);
        })
      : typeof module == "object" && module.exports
    ...
    function n(t22, e2) {
      ((this.element = t22), (this.parent = e2), this.create());
    }
    var s = n.prototype;
    return (
      (s.create = function () {
      ...
      (s.setPosition = function (t22) {
        ((this.x = t22), this.updateTarget(), this.renderPosition(t22));
      }),
      (s.updateTarget = s.setDefaultTarget =
        function () {
          ...
          this.target =
            this.x + this.size[t22] + this.size.width * this.parent.cellAlign;
        }),
      (s.renderPosition = function (t22) {
        var e2 = this.parent.originSide === "left" ? 1 : -1,
          i2 = this.parent.options.percentPosition
            ? t22 * e2 * (this.parent.size.innerWidth / this.size.width)
            : t22 * e2;
        this.element.style.transform =
          "translateX(" + this.parent.getPositionValue(i2) + ")";
      }),
      (s.select = function () {
      ...
      (s.wrapShift = function (t22) {
        ((this.shift = t22),
          this.renderPosition(this.x + this.parent.slideableWidth * t22));
      }),
      (s.remove = function () {
  ...
  (function (t22, e) {
    typeof define == "function" && define.amd
      ...
      : typeof module == "object" && module.exports
        ? (module.exports = e())
        : ((t22.Flickity = t22.Flickity || {}), (t22.Flickity.Slide = e()));
  })(window, function () {
    "use strict";
    function e(t22) {
      ((this.parent = t22),
        (this.isOriginLeft = t22.originSide == "left"),
        (this.cells = []),
        (this.outerWidth = 0),
        (this.height = 0));
    }
    var i = e.prototype;
    return (
      (i.addCell = function (t22) {
        if (
          (this.cells.push(t22),
          (this.outerWidth += t22.size.outerWidth),
          (this.height = Math.max(t22.size.outerHeight, this.height)),
          this.cells.length == 1)
        ) {
          this.x = t22.x;
      ...
      (i.select = function () {
        this.cells.forEach(function (t22) {
          t22.select();
        });
      }),
      (i.unselect = function () {
      ...
      (i.getCellElements = function () {
        return this.cells.map(function (t22) {
          return t22.element;
        });
      }),
      e
  ...
  (function (e, i) {
    typeof define == "function" && define.amd
      ? define("flickity/js/animate", ["fizzy-ui-utils/utils"], function (t22) {
          return i(e, t22);
        })
      : typeof module == "object" && module.exports
    ...
    return (
      ...
      (n.positionSlider = function () {
        ...
        (this.options.wrapAround &&
          this.cells.length > 1 &&
          ((t22 = i.modulo(t22, this.slideableWidth)),
          (t22 -= this.slideableWidth),
          this.shiftWrapCells(t22)),
          this.setTranslateX(t22, this.isAnimating),
          this.dispatchScrollEvent());
      }),
      (n.setTranslateX = function (t22, e2) {
        ((t22 += this.cursorPosition),
          (t22 = this.options.rightToLeft ? -t22 : t22));
        var i2 = this.getPositionValue(t22);
        this.slider.style.transform = e2
          ? "translate3d(" + i2 + ",0,0)"
          : "translateX(" + i2 + ")";
      }),
      ...
      (n.getPositionValue = function (t22) {
        return this.options.percentPosition
          ? Math.round((t22 / this.size.innerWidth) * 1e4) * 0.01 + "%"
          : Math.round(t22) + "px";
      }),
      (n.settle = function (t22) {
        var e2 =
          !this.isPointerDown &&
          Math.round(this.x * 100) == Math.round(t22 * 100);
        (e2 && this.restingFrames++,
      ...
      (n.shiftWrapCells = function (t22) {
        ...
        var i2 =
          ...
          (t22 + this.slideableWidth + this.cursorPosition);
  ...
  (function (o, a) {
    if (typeof define == "function" && define.amd)
      define("flickity/js/flickity", [
        ...
        "./slide",
        "./animate",
      ], function (t23, e, i, n, s, r) {
        return a(o, t23, e, i, n, s, r);
      });
    ...
    var l = n.jQuery,
      ...
      c = n.console;
    function u(t22, e2) {
      for (t22 = a.makeArray(t22); t22.length; ) e2.appendChild(t22.shift());
    }
    var d = 0,
      f = {};
    function p(t22, e2) {
      ...
      if (!i2) {
        c && c.error("Bad element for Flickity: " + (i2 || t22));
        return;
      }
      if (((this.element = i2), this.element.flickityGUID)) {
        var n2 = f[this.element.flickityGUID];
    ...
    (a.extend(v, e.prototype),
      (v._create = function () {
        ...
        (p.createMethods.forEach(function (t23) {
          this[t23]();
        }, this),
          this.options.watchCSS ? this.watchCSS() : this.activate());
      }),
      (v.option = function (t22) {
        a.extend(this.options, t22);
      }),
      (v.activate = function () {
        if (!this.isActive) {
          ((this.isActive = !0),
      ...
      (v._createSlider = function () {
        var t22 = document.createElement("div");
        ((t22.className = "flickity-slider"),
          (t22.style[this.originSide] = 0),
          (this.slider = t22));
      }),
      (v._filterFindCellElements = function (t22) {
        return a.filterFindElements(t22, this.options.cellSelector);
      }),
      ...
      (v._makeCells = function (t22) {
        var e2 = this._filterFindCellElements(t22),
          i2 = e2.map(function (t23) {
            return new s(t23, this);
          }, this);
        return i2;
      }),
      ...
      (v._positionCells = function (t22) {
        ((t22 = t22 || 0),
          (this.maxCellHeight = (t22 && this.maxCellHeight) || 0));
        var e2 = 0;
        if (t22 > 0) {
        ...
        for (var n2 = this.cells.length, s2 = t22; s2 < n2; s2++) {
          ...
          (r2.setPosition(e2),
            (e2 += r2.size.outerWidth),
            (this.maxCellHeight = Math.max(
              r2.size.outerHeight,
              this.maxCellHeight,
            )));
        }
        ((this.slideableWidth = e2),
          this.updateSlides(),
          this._containSlides(),
          (this.slidesWidth = n2
        ...
        if (((this.slides = []), !!this.cells.length)) {
          ...
          (this.cells.forEach(function (t23, e2) {
            ...
            var i2 =
              n2.outerWidth -
              n2.firstMargin +
              (t23.size.outerWidth - t23.size[s2]);
            (r2.call(this, e2, i2) ||
              (n2.updateTarget(), (n2 = new o(this)), this.slides.push(n2)),
              n2.addCell(t23));
          }, this),
            n2.updateTarget(),
      ...
      (v._getCanCellFit = function () {
        ...
        return function (t23, e3) {
          return e3 <= (this.size.innerWidth + 1) * n2;
        };
      }),
    ...
    return (
      ...
      (v._getWrapShiftCells = function () {
        if (this.options.wrapAround) {
          ...
          ((this.beforeShiftCells = this._getGapCells(t22, e2, -1)),
            (t22 = this.size.innerWidth - this.cursorPosition),
            (this.afterShiftCells = this._getGapCells(t22, 0, 1)));
        }
      }),
      ...
      (v._containSlides = function () {
        if (
          ...
          this.slides.forEach(function (t23) {
            s2
              ? (t23.target = n2 * this.cellAlign)
              : ((t23.target = Math.max(t23.target, r2)),
                (t23.target = Math.min(t23.target, o2)));
          }, this);
        }
      }),
      ...
      (v.select = function (t22, e2, i2) {
        if (
          this.isActive &&
          ((t22 = parseInt(t22, 10)),
          this._wrapSelect(t22),
          (this.options.wrapAround || e2) &&
            (t22 = a.modulo(t22, this.slides.length)),
          !!this.slides[t22])
        ) {
          var n2 = this.selectedIndex;
          ((this.selectedIndex = t22),
            this.updateSelectedSlide(),
            i2 ? this.positionSliderAtSelected() : this.startAnimation(),
            this.options.adaptiveHeight && this.setGallerySize(),
            this.dispatchEvent("select", null, [t22]),
            t22 != n2 && this.dispatchEvent("change", null, [t22]),
      ...
      (v._wrapSelect = function (t22) {
        ...
        (!this.isDragSelect && r2 < s2
          ? (t22 += e2)
          : !this.isDragSelect && o2 < s2 && (t22 -= e2),
          t22 < 0
            ? (this.x -= this.slideableWidth)
            : t22 >= e2 && (this.x += this.slideableWidth));
      }),
      (v.previous = function (t22, e2) {
      ...
      (v.updateSelectedSlide = function () {
        ...
        t22 &&
          ...
          (this.selectedSlide = t22),
          t22.select(),
          (this.selectedCells = t22.cells),
          (this.selectedElements = t22.getCellElements()),
          (this.selectedCell = t22.cells[0]),
      ...
      (v.selectInitialIndex = function () {
        ...
        if (t22 && typeof t22 == "string") {
          var e2 = this.queryCell(t22);
          if (e2) {
      ...
      (v.getCell = function (t22) {
        for (var e2 = 0; e2 < this.cells.length; e2++) {
          var i2 = this.cells[e2];
          if (i2.element == t22) return i2;
        }
      }),
      (v.getCells = function (t22) {
        t22 = a.makeArray(t22);
        var i2 = [];
        return (
          t22.forEach(function (t23) {
      ...
      (v.getParentCell = function (t22) {
        var e2 = this.getCell(t22);
        return (
          e2 ||
          ((t22 = a.getParent(t22, ".flickity-slider > *")), this.getCell(t22))
        );
      }),
      (v.getAdjacentCellElements = function (t22, e2) {
      ...
      (v.childUIPointerDown = function (t22) {
        (t22.type != "touchstart" && t22.preventDefault(), this.focus());
      }),
      (v.onresize = function () {
      ...
      (v.focus = function () {
        ...
        (this.element.focus({ preventScroll: !0 }),
          n.pageYOffset != t22 && n.scrollTo(n.pageXOffset, t22));
      }),
      ...
      a.extend(v, r),
      (p.data = function (t22) {
        t22 = a.getQueryElement(t22);
        var e2 = t22 && t22.flickityGUID;
        return e2 && f[e2];
      }),
      a.htmlInit(p, "flickity"),
      l && l.bridget && l.bridget("flickity", p),
      (p.setJQuery = function (t22) {
        l = t22;
      }),
      (p.Cell = s),
      (p.Slide = o),
 ...
 */ (function (e, i) {
  ...
  ((r.bindStartEvent = function (t22) {
    this._bindStartEvent(t22, !0);
  }),
    (r.unbindStartEvent = function (t22) {
      this._bindStartEvent(t22, !1);
    }),
    (r._bindStartEvent = function (t22, e2) {
      e2 = e2 === void 0 ? !0 : e2;
      var i2 = e2 ? "addEventListener" : "removeEventListener",
        n2 = "mousedown";
      ("ontouchstart" in s
        ? (n2 = "touchstart")
        : s.PointerEvent && (n2 = "pointerdown"),
        t22[i2](n2, this));
    }),
    ...
    (r.getTouch = function (t22) {
      for (var e2 = 0; e2 < t22.length; e2++) {
        var i2 = t22[e2];
        if (i2.identifier == this.pointerIdentifier) return i2;
      }
    }),
    (r.onmousedown = function (t22) {
      var e2 = t22.button;
      (e2 && e2 !== 0 && e2 !== 1) || this._pointerDown(t22, t22);
    }),
    (r.ontouchstart = function (t22) {
      this._pointerDown(t22, t22.changedTouches[0]);
    }),
    (r.onpointerdown = function (t22) {
      this._pointerDown(t22, t22);
    }),
    (r._pointerDown = function (t22, e2) {
      t22.button ||
        this.isPointerDown ||
        ((this.isPointerDown = !0),
        (this.pointerIdentifier =
          e2.pointerId !== void 0 ? e2.pointerId : e2.identifier),
        this.pointerDown(t22, e2));
    }),
    (r.pointerDown = function (t22, e2) {
      (this._bindPostStartEvents(t22),
        this.emitEvent("pointerDown", [t22, e2]));
    }));
  var o = {
  ...
  return (
    (r._bindPostStartEvents = function (t22) {
      if (t22) {
        var e2 = o[t22.type];
        (e2.forEach(function (t23) {
          s.addEventListener(t23, this);
        }, this),
          (this._boundPointerEvents = e2));
      }
    }),
    (r._unbindPostStartEvents = function () {
      this._boundPointerEvents &&
        (this._boundPointerEvents.forEach(function (t22) {
          s.removeEventListener(t22, this);
        }, this),
        delete this._boundPointerEvents);
    }),
    (r.onmousemove = function (t22) {
      this._pointerMove(t22, t22);
    }),
    (r.onpointermove = function (t22) {
      t22.pointerId == this.pointerIdentifier && this._pointerMove(t22, t22);
    }),
    (r.ontouchmove = function (t22) {
    ...
    (r.pointerMove = function (t22, e2) {
      this.emitEvent("pointerMove", [t22, e2]);
    }),
    (r.onmouseup = function (t22) {
      this._pointerUp(t22, t22);
    }),
    (r.onpointerup = function (t22) {
      t22.pointerId == this.pointerIdentifier && this._pointerUp(t22, t22);
    }),
    (r.ontouchend = function (t22) {
      var e2 = this.getTouch(t22.changedTouches);
    ...
    (r.pointerDone = i),
    (r.onpointercancel = function (t22) {
      t22.pointerId == this.pointerIdentifier && this._pointerCancel(t22, t22);
    }),
    (r.ontouchcancel = function (t22) {
      var e2 = this.getTouch(t22.changedTouches);
    ...
    (n.getPointerPoint = function (t22) {
      return { x: t22.pageX, y: t22.pageY };
    }),
    n
  );
});
 ...
 */ ((function (e, i) {
  ...
  ((n.bindHandles = function () {
    ...
    (n._bindHandles = function (t22) {
      t22 = t22 === void 0 ? !0 : t22;
      for (
        var e2 = t22 ? "addEventListener" : "removeEventListener",
          i2 = t22 ? this._touchActionValue : "",
          n2 = 0;
        n2 < this.handles.length;
        n2++
      ) {
        var s2 = this.handles[n2];
        (this._bindStartEvent(s2, t22),
          s2[e2]("click", this),
          r.PointerEvent && (s2.style.touchAction = i2));
      }
    }),
    (n._touchActionValue = "none"),
    (n.pointerDown = function (t22, e2) {
      var i2 = this.okayPointerDown(t22);
      i2 &&
        ((this.pointerDownPointer = { pageX: e2.pageX, pageY: e2.pageY }),
        t22.preventDefault(),
  ...
  return (
    (n.okayPointerDown = function (t22) {
    ...
    (n.pointerMove = function (t22, e2) {
      ...
      (this.emitEvent("pointerMove", [t22, e2, i2]),
        this._dragMove(t22, e2, i2));
    }),
    (n._dragPointerMove = function (t22, e2) {
      var i2 = {
        x: e2.pageX - this.pointerDownPointer.pageX,
        y: e2.pageY - this.pointerDownPointer.pageY,
      };
      return (
        !this.isDragging && this.hasDragStarted(i2) && this._dragStart(t22, e2),
        i2
      );
    }),
    (n.hasDragStarted = function (t22) {
      return Math.abs(t22.x) > 3 || Math.abs(t22.y) > 3;
    }),
    (n.pointerUp = function (t22, e2) {
      (this.emitEvent("pointerUp", [t22, e2]), this._dragPointerUp(t22, e2));
    }),
    (n._dragPointerUp = function (t22, e2) {
      this.isDragging ? this._dragEnd(t22, e2) : this._staticClick(t22, e2);
    }),
    (n._dragStart = function (t22, e2) {
      ((this.isDragging = !0),
        (this.isPreventingClicks = !0),
        this.dragStart(t22, e2));
    }),
    (n.dragStart = function (t22, e2) {
      this.emitEvent("dragStart", [t22, e2]);
    }),
    (n._dragMove = function (t22, e2, i2) {
      this.isDragging && this.dragMove(t22, e2, i2);
    }),
    (n.dragMove = function (t22, e2, i2) {
      (t22.preventDefault(), this.emitEvent("dragMove", [t22, e2, i2]));
    }),
    (n._dragEnd = function (t22, e2) {
      ((this.isDragging = !1),
        setTimeout(
          function () {
    ...
    (n.dragEnd = function (t22, e2) {
      this.emitEvent("dragEnd", [t22, e2]);
    }),
    (n.onclick = function (t22) {
      this.isPreventingClicks && t22.preventDefault();
    }),
    (n._staticClick = function (t22, e2) {
      (this.isIgnoringMouseUp && t22.type == "mouseup") ||
        (this.staticClick(t22, e2),
        t22.type != "mouseup" &&
  ...
  (function (n, s) {
    ...
    (a.extend(s, i.prototype),
      ...
      (s.pointerDown = function (t22, e2) {
        if (!this.isDraggable) {
          this._pointerDownDefault(t22, e2);
          return;
        }
        var i2 = this.okayPointerDown(t22);
        i2 &&
          (this._pointerDownPreventDefault(t22),
          this.pointerDownFocus(t22),
      ...
      (s._pointerDownDefault = function (t22, e2) {
        ((this.pointerDownPointer = { pageX: e2.pageX, pageY: e2.pageY }),
          this._bindPostStartEvents(t22),
          this.dispatchEvent("pointerDown", t22, [e2]));
      }));
    ...
    ((s.pointerDownFocus = function (t22) {
      ...
      (s.hasDragStarted = function (t22) {
        return Math.abs(t22.x) > this.options.dragThreshold;
      }),
      (s.pointerUp = function (t22, e2) {
        (delete this.isTouchScrolling,
          this.viewport.classList.remove("is-pointer-down"),
          this.dispatchEvent("pointerUp", t22, [e2]),
          this._dragPointerUp(t22, e2));
      }),
      (s.pointerDone = function () {
        (n.removeEventListener("scroll", this), delete this.pointerDownScroll);
      }),
      (s.dragStart = function (t22, e2) {
        this.isDraggable &&
          ((this.dragStartPosition = this.x),
          this.startAnimation(),
          n.removeEventListener("scroll", this),
          this.dispatchEvent("dragStart", t22, [e2]));
      }),
      (s.pointerMove = function (t22, e2) {
        var i2 = this._dragPointerMove(t22, e2);
        (this.dispatchEvent("pointerMove", t22, [e2, i2]),
          this._dragMove(t22, e2, i2));
      }),
      (s.dragMove = function (t22, e2, i2) {
        if (this.isDraggable) {
          ...
          if (!this.options.wrapAround && this.slides.length) {
            ...
            s2 = s2 > r2 ? (s2 + r2) * 0.5 : s2;
            var o2 = Math.min(
              -this.getLastSlide().target,
              this.dragStartPosition,
            );
            s2 = s2 < o2 ? (s2 + o2) * 0.5 : s2;
          }
          ((this.dragX = s2),
            (this.dragMoveTime = new Date()),
            this.dispatchEvent("dragMove", t22, [e2, i2]));
        }
      }),
        ...
        if (this.isDraggable) {
          ...
          if (this.options.freeScroll && !this.options.wrapAround) {
            ...
            this.isFreeScrolling =
              -n2 > this.slides[0].target && -n2 < this.getLastSlide().target;
          } else
            !this.options.freeScroll &&
              i2 == this.selectedIndex &&
              (i2 += this.dragEndBoostSelect());
          (delete this.previousDragX,
            (this.isDragSelect = this.options.wrapAround),
            this.select(i2),
            delete this.isDragSelect,
            this.dispatchEvent("dragEnd", t22, [e2]));
        }
      }),
      ...
      (s._getClosestResting = function (t22, e2, i2) {
        for (
          var n2 = this.selectedIndex,
            s2 = 1 / 0,
            r2 =
          ...
          ((n2 += i2),
          (s2 = e2),
          (e2 = this.getSlideDistance(-t22, n2)),
          e2 !== null);
        )
          e2 = Math.abs(e2);
        return { distance: s2, index: n2 - i2 };
      }),
      (s.getSlideDistance = function (t22, e2) {
        var i2 = this.slides.length,
  ...
  (function (n, s) {
  ...
  })(window, function (e, i, n, s) {
    "use strict";
    var r = "http://www.w3.org/2000/svg";
    function o(t22, e2) {
      ((this.direction = t22), (this.parent = e2), this._create());
    }
    ((o.prototype = Object.create(n.prototype)),
      (o.prototype._create = function () {
        ...
        ((e2.className = "flickity-button flickity-prev-next-button"),
          (e2.className += this.isPrevious ? " previous" : " next"),
          e2.setAttribute("type", "button"),
          this.disable(),
          e2.setAttribute("aria-label", this.isPrevious ? "Previous" : "Next"));
      ...
      (o.prototype.createSVG = function () {
        ...
        (t22.setAttribute("class", "flickity-button-icon"),
          t22.setAttribute("viewBox", "0 0 100 100"));
        var e2 = document.createElementNS(r, "path"),
          i2 = a(this.parent.options.arrowShape);
        return (
          e2.setAttribute("d", i2),
          e2.setAttribute("class", "arrow"),
          this.isLeft ||
            e2.setAttribute("transform", "translate(100, 100) rotate(180) "),
          t22.appendChild(e2),
          t22
        );
      }));
    function a(t22) {
      return typeof t22 == "string"
        ? t22
        : "M " +
            t22.x0 +
            ",50 L " +
    ...
    ((o.prototype.handleEvent = s.handleEvent),
      ...
      (o.prototype.update = function () {
        ...
        if (this.parent.options.wrapAround && t22.length > 1) {
          this.enable();
          return;
        }
    ...
    ((r.prototype = Object.create(n.prototype)),
      ...
      (r.prototype.addDots = function (t22) {
        for (
          ...
          ((o2.className = "dot"),
            o2.setAttribute("aria-label", "Page dot " + (r2 + 1)),
            e2.appendChild(o2),
            i2.push(o2));
        }
  ...
  (function (t22, n) {
    typeof define == "function" && define.amd
      ...
      : typeof module == "object" && module.exports
        ...
        : n(t22.EvEmitter, t22.fizzyUIUtils, t22.Flickity);
  })(window, function (e, i, n) {
    function s(t22) {
      ((this.parent = t22),
        (this.state = "stopped"),
  ...
  (function (i, n) {
    ...
    return (
      ...
      (s.append = function (t22) {
        this.insert(t22, this.cells.length);
      }),
      (s.prepend = function (t22) {
        this.insert(t22, 0);
      }),
      (s.remove = function (t22) {
      ...
      (s.cellChange = function (t22, e2) {
        ...
        (this._positionCells(t22),
          this._getWrapShiftCells(),
          this.setGallerySize());
        var n2 = this.getCell(i2);
        (n2 && (this.selectedIndex = this.getCellSlideIndex(n2)),
          (this.selectedIndex = Math.min(
            this.slides.length - 1,
            this.selectedIndex,
          )),
          this.emitEvent("cellChange", [t22]),
          this.select(this.selectedIndex),
          e2 && this.positionSliderAtSelected());
      }),
      i
    );
  }),
  (function (i, n) {
    ...
    function r(t22, e2) {
      ((this.img = t22), (this.flickity = e2), this.load());
    }
    return (
      ...
      (r.prototype.load = function () {
        ...
        ((this.img.src = t22),
          e2 && this.img.setAttribute("srcset", e2),
          this.img.removeAttribute("data-flickity-lazyload"),
          this.img.removeAttribute("data-flickity-lazyload-src"),
          this.img.removeAttribute("data-flickity-lazyload-srcset"));
      }),
      (r.prototype.onload = function (t22) {
        this.complete(t22, "flickity-lazyloaded");
      }),
      (r.prototype.onerror = function (t22) {
        this.complete(t22, "flickity-lazyerror");
      }),
      (r.prototype.complete = function (t22, e2) {
        (this.img.removeEventListener("load", this),
          this.img.removeEventListener("error", this));
        var i2 = this.flickity.getParentCell(this.img),
          n2 = i2 && i2.element;
        (this.flickity.cellSizeChange(n2),
          this.img.classList.add(e2),
          this.flickity.dispatchEvent("lazyLoad", t22, n2));
      }),
      (i.LazyLoader = r),
      i
    );
 ...
 */ (function (t22, e) {
  typeof define == "function" && define.amd
    ...
    : typeof module == "object" && module.exports
      ...
      : (t22.Flickity = e(t22.Flickity, t22.fizzyUIUtils));
})(window, function (n, s) {
  ...
  ((e._createAsNavFor = function () {
    ...
    (e.setNavCompanion = function (t22) {
      ...
      if (!(!e2 || e2 == this)) {
        ...
        ((this.onNavCompanionSelect = function () {
          ...
          e2.on("select", this.onNavCompanionSelect),
    ...
    (e.navCompanionSelect = function (t22) {
      ...
      if (e2) {
        ...
        if (
          (this.selectCell(r, !1, t22),
          this.removeNavSelectedElements(),
          !(r >= this.cells.length))
        ) {
          var o = this.cells.slice(n2, s2 + 1);
          ((this.navSelectedElements = o.map(function (t23) {
            return t23.element;
          })),
  ...
  return (
    (e.changeNavSelectedClass = function (e2) {
      this.navSelectedElements.forEach(function (t22) {
        t22.classList[e2]("is-nav-selected");
      });
    }),
    ...
    (e.onNavStaticClick = function (t22, e2, i, n2) {
      typeof n2 == "number" && this.navCompanion.selectCell(n2);
    }),
 ...
 */ (function (e, i) {
  ...
  var s = e.jQuery,
    r = e.console;
  function o(t22, e2) {
    for (var i2 in e2) t22[i2] = e2[i2];
    return t22;
  }
  var n = Array.prototype.slice;
  function a(t22) {
    if (Array.isArray(t22)) return t22;
    var e2 = typeof t22 == "object" && typeof t22.length == "number";
    return e2 ? n.call(t22) : [t22];
  }
  function l(t22, e2, i2) {
    if (!(this instanceof l)) return new l(t22, e2, i2);
    var n2 = t22;
    if (
      (typeof t22 == "string" && (n2 = document.querySelectorAll(t22)), !n2)
    ) {
      r.error("Bad element for imagesLoaded " + (n2 || t22));
      return;
    }
    ((this.elements = a(n2)),
      (this.options = o({}, this.options)),
      typeof e2 == "function" ? (i2 = e2) : o(this.options, e2),
      i2 && this.on("always", i2),
      this.getImages(),
  ...
  ((l.prototype = Object.create(i.prototype)),
    ...
    (l.prototype.addElementImages = function (t22) {
      (t22.nodeName == "IMG" && this.addImage(t22),
        this.options.background === !0 && this.addElementBackgroundImages(t22));
      var e2 = t22.nodeType;
      if (!(!e2 || !h[e2])) {
        for (
          var i2 = t22.querySelectorAll("img"), n2 = 0;
          n2 < i2.length;
          n2++
        ) {
          var s2 = i2[n2];
  ...
  ((l.prototype.addElementBackgroundImages = function (t22) {
    ...
    if (e2)
      for (
        var i2 = /url\((['"])?(.*?)\1\)/gi, n2 = i2.exec(e2.backgroundImage);
        n2 !== null;
      ) {
        var s2 = n2 && n2[2];
    ...
    (l.prototype.check = function () {
      ...
      function e2(t22, e3, i2) {
        setTimeout(function () {
          n2.progress(t22, e3, i2);
        });
      }
      this.images.forEach(function (t22) {
        (t22.once("progress", e2), t22.check());
      });
    }),
    (l.prototype.progress = function (t22, e2, i2) {
      (this.progressedCount++,
        (this.hasAnyBroken = this.hasAnyBroken || !t22.isLoaded),
        this.emitEvent("progress", [this, t22, e2]),
        this.jqDeferred &&
          this.jqDeferred.notify &&
          this.jqDeferred.notify(this, t22),
  ...
  ((c.prototype = Object.create(i.prototype)),
    ...
    (c.prototype.confirm = function (t22, e2) {
      ((this.isLoaded = t22), this.emitEvent("progress", [this, this.img, e2]));
    }),
    (c.prototype.handleEvent = function (t22) {
      var e2 = "on" + t22.type;
      this[e2] && this[e2](t22);
    }),
  ...
  function u(t22, e2) {
    ((this.url = t22), (this.element = e2), (this.img = new Image()));
  }
  return (
    ...
    (u.prototype.confirm = function (t22, e2) {
      ((this.isLoaded = t22),
        this.emitEvent("progress", [this, this.element, e2]));
    }),
    (l.makeJQueryPlugin = function (t22) {
      ((t22 = t22 || e.jQuery),
        t22 &&
          ((s = t22),
          (s.fn.imagesLoaded = function (t23, e2) {
            var i2 = new l(this, t23, e2);
            return i2.jqDeferred.promise(s(this));
          })));
    }),
    l.makeJQueryPlugin(),
    l
 ...
 */ ((function (i, n) {
  ...
  return (
    ...
    (n.imagesLoaded = function () {
      ...
      function t22(t23, e2) {
        ...
        (n2.cellSizeChange(i2 && i2.element),
          n2.options.freeScroll || n2.positionSliderAtSelected());
      }
  ...
  (function (window2, factory2) {
    typeof define == "function" && define.amd
      ? define(["flickity/js/index", "fizzy-ui-utils/utils"], factory2)
      : typeof module == "object" && module.exports
        ? (module.exports = factory2(
            require("flickity"),
            require("fizzy-ui-utils"),
          ))
        : factory2(window2.Flickity, window2.fizzyUIUtils);
  })(this, function (Flickity2, utils) {
    var Slide = Flickity2.Slide,
      slideUpdateTarget = Slide.prototype.updateTarget;
    ((Slide.prototype.updateTarget = function () {
      if (
        (slideUpdateTarget.apply(this, arguments), !!this.parent.options.fade)
      ) {
    ...
    ((proto.positionSliderAtSelected = function () {
      ...
      (proto.fadeSlides = function () {
        if (!(this.slides.length < 2)) {
          ...
          var isNewHideIndex =
            this.fadeHideIndex != null &&
            this.fadeHideIndex != fadeHideIndex &&
            this.fadeHideIndex != indexes.a &&
            this.fadeHideIndex != indexes.b;
          (isNewHideIndex && this.slides[this.fadeHideIndex].setOpacity(0),
            (this.fadeHideIndex = fadeHideIndex));
        }
      }),
      ...
      (proto.getFadeDragWrapIndexes = function () {
        var distances = this.slides.map(function (slide, i) {
          ...
          absDistances = distances.map(function (distance2) {
      ...
      (proto.wrapDifference = function (a, b) {
        ...
        return (
          Math.abs(diffPlus) < Math.abs(diff) && (diff = diffPlus),
          Math.abs(diffMinus) < Math.abs(diff) && (diff = diffMinus),
          diff
        );
      }));
    var _getWrapShiftCells = proto._getWrapShiftCells;
    proto._getWrapShiftCells = function () {
      this.options.fade || _getWrapShiftCells.apply(this, arguments);
    };
    var shiftWrapCells = proto.shiftWrapCells;
    return (
      (proto.shiftWrapCells = function () {
        this.options.fade || shiftWrapCells.apply(this, arguments);
      }),
      Flickity2
    );
  }));
 ...
 */ ((function (t22, n) {
  ...
  ((e._createHash = function () {
    this.options.hash &&
      ...
      (this.onHashLinkClick = function (t22) {
        (t22.preventDefault(),
          this.selectCell(t22.currentTarget.hash),
          history.replaceState(null, "", t22.currentTarget.hash));
      }.bind(this)),
    ...
    (e.activateHash = function () {
      if (
        ...
        this.options.initialIndex === void 0 && location.hash)
      ) {
    ...
    (e.connectHashLinks = function () {
      for (
        var t22 = document.querySelectorAll("a"), n2 = 0;
        n2 < t22.length;
        n2++
      )
        this.connectHashLink(t22[n2]);
    }));
  var i = document.createElement("a");
  return (
    (e.connectHashLink = function (t22) {
      t22.hash &&
        ((i.href = t22.href), i.pathname == location.pathname) &&
        this.queryCell(t22.hash) &&
        (t22.addEventListener("click", this.onHashLinkClick),
        this.connectedHashLinks.push(t22));
    }),
    (e.disconnectHashLinks = function () {
      (this.connectedHashLinks.forEach(function (t22) {
        t22.removeEventListener("click", this.onHashLinkClick);
      }, this),
        (this.connectedHashLinks = []));
    }),
    n
  ...
  (Flickity.prototype.setPrevNextCells = function () {
    (changeSlideClasses(this.previousSlide, "remove", "is-previous"),
      ...
      this.selectedIndex + 1 === this.slides.length
